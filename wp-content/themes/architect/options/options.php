	...
	*/
	function _enqueue(){
        ...
        wp_localize_script( 'nhp-opts-js', 'nhpopts', array(
            ...
            'import_widget_confirm' => __('Are you sure you want to import demo options and widgets? All current options will be lost and existing widgets deactivated.', 'MTSTHEMENAME' ),
                                ...
                                foreach ( $this->args['presets'] as $key => $preset ) {
                                    echo '<div class="preset" data-nonce="'.$nonce.'" data-demo-id="'.esc_attr($key).'">';
                                        ...
                                        echo '<div class="preset-actions-wrap">';
                                        	...
                                        	echo '<button class="button button-secondary import-demo-widgets-button"'.$disabled_button.'>'.__('Import Theme Options & Widgets', 'MTSTHEMENAME' ).'</button>';
                                        	if ( !empty( $all_imported ) ) {
                                        		echo '<button class="button button-primary remove-demo-button" data-nonce="'.$nonce.'">'.__('Remove imported data', 'MTSTHEMENAME' ).'</button>';
                                        	} else {
                                        		echo '<button class="button button-secondary import-demo-button"'.$disabled_button.'>'.__('Import Theme Options, Widgets & Content', 'MTSTHEMENAME' ).'</button>';
                                        	}
                                        echo '</div>';
