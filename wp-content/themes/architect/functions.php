...
define( 'MTS_THEME_TEXTDOMAIN', 'architect');
define( 'MTS_THEME_VERSION', '1.1.1' );
...
function mts_move_comment_field_to_bottom( $fields ) {
    $comment_field = $fields['comment'];
    unset( $fields['comment'] );
    $fields['comment'] = $comment_field;
    return $fields;
}
add_filter( 'comment_form_fields', 'mts_move_comment_field_to_bottom' );
